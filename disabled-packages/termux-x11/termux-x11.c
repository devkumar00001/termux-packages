...
# define TERMUX_PREFIX "/data/data/com dragon.ide/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/com dragon.ide.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "com dragon.ide.x11/.MainActivity", NULL};
